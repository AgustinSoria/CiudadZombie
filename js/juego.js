...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/valla_horizontal.png', 70, 430, 30, 25, 1),
    new Obstaculo('imagenes/valla_vertical.png', 205, 480, 30, 22, 1),
    new Obstaculo('imagenes/valla_vertical.png', 510, 200, 30, 22, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 760, 450, 30, 25, 1),
    new Obstaculo('imagenes/auto_verde_abajo.png', 290, 390, 20, 40, 1),
    new Obstaculo('imagenes/auto_verde_derecha.png', 840, 240, 40, 20, 1),
    new Obstaculo('imagenes/auto_verde_derecha.png', 520, 450, 40, 20, 1),
    new Obstaculo('imagenes/bache.png', 600, 80, 20, 20, 1),
    new Obstaculo('imagenes/bache.png', 760, 150, 20, 20, 1),
    new Obstaculo('imagenes/kit.png', 280, 80, 25, 25, -2),
  ...
  enemigos: [
    new ZombieCaminante('imagenes/zombie1.png', 350, 450, 20, 30, 0.75, {desdeX: 50, hastaX: 450, desdeY: 10, hastaY: 600}),  
    new ZombieCaminante('imagenes/zombie1.png', 100, 350, 20, 30, 0.75, { desdeX: 50, hastaX: 450, desdeY: 10, hastaY: 600 }),  
    new ZombieCaminante('imagenes/zombie2.png', 300, 80, 20, 30, 1, { desdeX: 200, hastaX: 500, desdeY: 10, hastaY: 400 }), 
    new ZombieCaminante('imagenes/zombie2.png', 450, 250, 20, 30, 1, { desdeX: 200, hastaX: 600, desdeY: 10, hastaY: 750 }), 
    new ZombieCaminante('imagenes/zombie3.png', 650, 300, 20, 30, 1.25, { desdeX: 500, hastaX: 850, desdeY: 200, hastaY: 570 }),  
    new ZombieCaminante('imagenes/zombie4.png', 850, 440, 20, 30, 1.25, { desdeX: 500, hastaX: 850, desdeY: 200, hastaY: 570 }), 
    new ZombieConductor('imagenes/tren_vertical.png', 646, 577, 28, 75, 5, { desdeX: 0, hastaX: 0, desdeY: 0, hastaY: 577 }, 'vertical'), 
    new ZombieConductor('imagenes/tren_vertical.png', 678, 577, 28, 75, 2.5, { desdeX: 0, hastaX: 0, desdeY: 0, hastaY: 577 }, 'vertical'), 
    new ZombieConductor('imagenes/tren_horizontal.png', 961, 322, 75, 28, 5, { desdeX: 0, hastaX: 961, desdeY: 0, hastaY: 0 }, 'horizontal') 
  ]
...
Juego.dibujar = function() {
  ...
  // BORRAR TODO CUANDO GANES EL Juego
  ...
  Dibujante.dibujarImagen('imagenes/llegada.png', 760, 490, 126, 75);
